...
##script.Print("**************************************************");
  script.Print("**********************************************************************")
  script.Print("**********************************************************************")
  script.Print("________*******************__________*************_____***************")
  script.Print("___  __ \___  ________________  ____/___  ___________(_)____________**")
  script.Print("__  /_/ /  / / /_  ___/  _ \_  /_   _  / / /_  ___/_  /_  __ \_  __ \*")
  script.Print("_  ____// /_/ /_  /   /  __/  __/   / /_/ /_(__  )_  / / /_/ /  / / /*")
  script.Print("/_/     \__,_/ /_/    \___//_/      \__,_/ /____/ /_/  \____//_/ /_/ *")
  script.Print("**********************************************************************")                                                                
  script.Print("**********************************************************************")
  script.Print("**********************************************************************")
